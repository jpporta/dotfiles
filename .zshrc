...
plugins=(web-search git zsh-autosuggestions zsh-syntax-highlighting)
...
export PATH=$PATH:/usr/local/go/bin:~/.local/bin:~/.local/scripts
...
alias bc="bc -l -q"
alias zoom="export XDG_CURRENT_DESKTOP=gnome && /usr/bin/zoom"
