...
local lang_maps = {
	...
	typescript = { build = "yarn build", exec = "yarn dev" },
	javascript = { build = "yarn build", exec = "yarn dev" },
	python = { exec = "python %" },
...
vim.api.nvim_create_autocmd("BufWritePre", {
	...
	pattern = "*.cpp,*.css,*.go,*.h,*.html,*.js,*.json,*.jsx,*.lua,*.md,*.py,*.rs,*.ts,*.tsx,*.yaml,*.tsx,*.jsx,*.scss",
})
